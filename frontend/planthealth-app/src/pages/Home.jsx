...
export const Home = ({ onAnalyze, onHelpClick, onHomeClick }) => {
    ...
    <>
      ...
      <main className="w-full pt-[88px] pb-[100px] px-4 max-w-2xl mx-auto flex flex-col gap-6">
        <section className="flex flex-col gap-1 pt-4">
          <h1 className="font-bold text-[32px] leading-10 text-on-background dark:text-white">Analyze Plant</h1>
          <p className="text-[16px] leading-6 text-on-surface-variant dark:text-gray-300">
        ...
        {!selectedFile ? (
          ...
          <div className="flex flex-col gap-4">
            ...
            <button 
              ...
              className="text-primary dark:text-[#8cc28f] font-medium text-sm self-end hover:underline"
            >
        ...
        <section className="pt-3">
          ...
          {!selectedFile && (
            <p className="text-center font-medium text-[12px] text-outline dark:text-gray-400 mt-3">
